...
import 'package:wartegnusantara/app.dart';
...
import 'package:wartegnusantara/screens/transaction/transaction.dart';
import 'package:wartegnusantara/splash/splash.dart';
...
void main() {
  ...
  group('AppView', () {
    ...
    testWidgets('navigates to HomePage when status is authenticated',
      ...
      await tester.pumpAndSettle();
      expect(find.byType(Transaction), findsOneWidget);
    });
  });
}
